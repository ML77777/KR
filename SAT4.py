    ...
    for lit in changed_literals:
        ...
        for clause_id in relevant_clauses:
            ...
            if clause_id in clauses_dict:
                clauses_dict1, clauses_count1, assignments1, new_changed_literals1, contradiction1, unassigned_literals1, lit_pos_occ1, lit_neg_occ1 = simplify_clause(clause_id, deepcopy(clauses_dict), clauses_count, assignments.copy(), new_changed_literals, contradiction, unassigned_literals.copy(), lit_pos_occ.copy(), lit_neg_occ.copy())
                if contradiction1:
